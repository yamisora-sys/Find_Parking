    ...
    <header class="header py-3" th:fragment="header">
        <div class="container d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div th:fragment="search-coordinate">
                <div class="d-flex" role="search" style="flex-grow: 1; max-width: 400px; margin-left: 10px; height: 40px">
                    <input class="form-control me-2" type="search" id="search-address" placeholder="Nhập vào địa điểm" aria-label="Search">
                    <button class="btn btn-outline-primary" onclick="searchCoordinates()" style="height: 40px; width: 100px">Tìm</button>
                </div>
            </div> 
            <!-- check if user login -->
        ...
        <script>
            async function searchCoordinates() {
                ...
                const url = `https://api.opencagedata.com/geocode/v1/json?q=${encodeURIComponent(searchAddress)}&key=${apiKey}`;
